...
function renderExtPage(area, extId) {
    ...
    switch(pageType) {
        case 'pesquisa': renderPesquisa(area, ext); break;
        case 'calculadora': renderCalculadora(area, ext); break;
        case 'noticias': renderNoticias(area, ext); break;
        case 'calendario': renderCalendario(area, ext); break;
        case 'ferramentas': renderFerramentas(area, ext); break;
        default: renderGenericExt(area, ext); break;
    }
}
